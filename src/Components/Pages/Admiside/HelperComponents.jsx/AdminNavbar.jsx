            ...
            <nav className='border-r border-gray-700  w-[320px] h-screen hidden  md:block fixed top-0 bg-[#000300]'>
                ...
                <div className='max-w-[200px] mx-auto mt-4'>
                    <ul className='flex-col'>
                        ...
                        <li className='flex gap-x-2 py-2 mt-3 cursor-pointer hover:bg-gray-900 rounded-md px-1 md:text-[18px] font-semibold'><span><BsFillFileImageFill size={24} /></span>Post Management</li>
